...
Sitrep_missing_or_zero <- Sitrep_daily %>% 
  ...
  select(!(cols_to_check_2)) %>% # only select variables that begin 2nd Nov first
  #gather(cols_to_check, key = "variable", value = "value")
  pivot_longer(cols_to_check_1, names_to = "variable", values_to = "value") %>% # replaced gather with pivot_longer
